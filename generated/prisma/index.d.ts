...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user" | "product" | "variant"
  ...
  export type ProductOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "description" | "photo" | "userId", ExtArgs["result"]["product"]>
  ...
  export type VariantOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"sku" | "size" | "color" | "price" | "stock" | "productId", ExtArgs["result"]["variant"]>
  ...
  export interface VariantDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `sku`
     * const variantWithSkuOnly = await prisma.variant.findMany({ select: { sku: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Variants and only return the `sku`
     * const variantWithSkuOnly = await prisma.variant.createManyAndReturn({
     *   select: { sku: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Variants and only return the `sku`
     * const variantWithSkuOnly = await prisma.variant.updateManyAndReturn({
     *   select: { sku: true },
     *   where: {
     *     // ... provide filter here
     *   },
